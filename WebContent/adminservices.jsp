...
if(request.getSession().getAttribute("loogedinadmin")!=null){ myAdmin = (Admin)request.getSession().getAttribute("loogedinadmin"); }%>
<script>
...
<div class="pcard">
<table>
<tr><td><label>USERID</label></td> <td><input type="text" id="adusr" name="adusr" readonly="readonly" value=<%=myAdmin.getAid() %>></td></tr>
<tr><td><label>NAME</label></td> <td><input class="admininput" type="text" id="adname" name="adname"  value= <%=myAdmin.getName() %>></td></tr>
<tr><td><label for="Phone">Phone</label></td> <td><input class="admininput" type="text" id="adh" name="adh" value=<%=myAdmin.getPhone() %>></td></tr>
<tr><td><label for="Email">Email</label></td> <td><input class="admininput" type="text" id="ademail" name="ademail" value=<%=myAdmin.getEmail() %>></td></tr>
<tr><td><label for="Email">Address</label></td> <td><input class="admininput" type="text" id="adaddress" name="adaddress" value=<%=myAdmin.getAddress() %>></td></tr>
<tr><td><label for="Email">State</label></td> <td><input class="admininput" type="text" id="adstate" name="adstate" value=<%=myAdmin.getState() %>></td></tr>
<tr><td><label for="Email">Zip</label></td> <td><input class="admininput" type="text" id="adzip" name="adzip" value=<%=myAdmin.getZip() %>></td></tr>
<tr><td><label for="Email">City</label></td> <td><input class="admininput" type="text" id="adcity" name="adcity" value=<%=myAdmin.getCity() %>></td></tr>
<tr><td><label for="Email">Country</label></td> <td><input class="admininput" type="text" id="adcountry" name="adcountry" value=<%=myAdmin.getCountry() %>></td></tr>
<tr><td><label for="Username">Username</label></td> <td><input class="admininput" type="text" id="aduname" name="aduname" readonly="readonly" value=<%=myAdmin.getUsername() %>></td></tr>
<tr><td><label for="Email">Password</label></td> <td><input class="admininput" type="password" id="adpassword" readonly="readonly" name="adpassword"value=<%=myAdmin.getPassword()%>></td></tr>
